 ...
 * </p>
 * <ul>
 *   <li>{@link com.polimi.ase.concretesyntax.xtext.smartCity.impl.FacebookImpl#getTexts <em>Texts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FacebookImpl extends PostImpl implements Facebook
{
  /**
  ...
  {
    return SmartCityPackage.Literals.FACEBOOK;
  }
  ...
  public EList<Paragraph> getTexts()
  {
    if (texts == null)
    {
      texts = new EObjectContainmentEList<Paragraph>(Paragraph.class, this, SmartCityPackage.FACEBOOK__TEXTS);
    }
    return texts;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SmartCityPackage.FACEBOOK__TEXTS:
